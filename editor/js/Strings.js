function Strings( config ) {
	...
	var values = {
		...
		en: {
			...
			'menubar/appTangible': 'App Tangible',
			'menubar/appTangible/connect': 'Connect',
			'menubar/appTangible/disconnect': 'Disconnect',
			...
			// TEST
			'sidebar/object/SensorsMenu': 'Sensors',
			'sidebar/object/SensorsMenuButton': 'Open Sensors Menu',
